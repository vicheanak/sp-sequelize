  ...
  up: function (queryInterface, Sequelize) {
   ...
   for (var i = 0; i < products.length; i ++){
       for (var k = 1; k < 62; k ++){
           ...
           var month = moment().subtract(k, 'days').format("MM");
           var year = moment().subtract(k, 'days').format("YYYY");
           data.push({amount: products[i], OutletId:4 , ProductId: i + 1, UserId: 3, orderDate: date, orderDay: day, orderMonth: month, orderYear: year, createdAt: date, updatedAt: date});
       }
   }
